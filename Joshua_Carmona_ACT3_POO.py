...
# Se crea una clase que va a heredar los metodos de la clase anterior, ademas de igualmente reutilizar dichos metodos con sus atributos
class Validar(SolicitarDatos):
    pass

# Se crea un objeto para instanciarse y usar la clase que hereda los metodos y atributos
Iniciar = Validar()
print(Iniciar)
